...
class AudioPlayer {
  ...
  Future<Map?> takeDuration() async{
    return await (await _platform)
        .takeDuration();
  }

  Future<Map?> takePosition() async{
    return await (await _platform)
        .takePosition();
  }
...
class _IdleAudioPlayer extends AudioPlayerPlatform {
  ...
  void _broadcastPlaybackEvent() {
    ...
    print('_broadcastPlaybackEvent'+_sequence!.length.toString()+_sequence!.last.duration.toString());

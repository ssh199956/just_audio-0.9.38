...
abstract class AudioPlayerPlatform {
  ...
  Future<Map?> takeDuration() {
    throw UnimplementedError("takeDuration() has not been implemented.");
  }

  /// Seeks to the given  position.
  Future<Map?> takePosition() {
    throw UnimplementedError("takePosition() has not been implemented.");
  }
...
class DurationResponse {
  static DurationResponse fromMap(Map<dynamic, dynamic> map) => DurationResponse();
}
